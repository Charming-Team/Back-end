...
public enum ErrorCode {
    ...
    REPORT_PDF_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "500-303", "PDF를 생성할 수 없습니다. 잠시 후 다시 시도해주세요."),
    REPORT_MAIL_SEND_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "500-304", "메일을 발송할 수 없습니다. 잠시 후 다시 시도해주세요."),
